...
enum AIType     { PATROL, GUARD, WIGGLE   };
...
public:
    ...
    void ai_walk();
    void ai_wiggle(Entity *player);
    void ai_guard(Entity *player);
    
    void normalise_movement() { m_movement = glm::normalize(m_movement); }

    void face_left() { m_animation_indices = m_walking[LEFT]; facing = false; }
    void face_right() { m_animation_indices = m_walking[RIGHT]; facing = true; }
