...
void Win::initialise()
{
    ...
    m_game_state.map = new Map(LEVEL_WIDTH, LEVEL_HEIGHT, WIN_DATA, map_texture_id, 1.0f, 10, 6);
...
void Win::render(ShaderProgram* program)
{
    ...
    Utility::draw_text(program, font_texture_id_1, "You won and escaped with all the jewelry!", 0.5f, -0.25f, glm::vec3(1.3f, -2.5f, 0.0f));
